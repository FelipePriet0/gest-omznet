      ...
      <div className="w-full space-y-2">
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <button
              type="button"
              className="mt-1 flex h-12 w-full items-center justify-between rounded-lg border-0 bg-white px-5 py-3 text-left text-sm text-zinc-900 shadow-none outline-none focus-visible:ring-0"
            >
          ...
          <PopoverContent align="start" sideOffset={6} className="w-[260px] p-2 bg-white border-0 shadow-none rounded-md mz-time-popover">
