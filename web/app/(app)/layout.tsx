    ...
    <RouteBg>
      <SidebarProvider open={open} setOpen={setOpen}>
        <div className="text-zinc-900 min-h-screen" style={{ backgroundColor: 'var(--color-primary)' }}>
          ...
          >
            <main className={`p-2 md:p-6 rounded-tl-3xl border border-neutral-200 dark:border-neutral-700 ${isExpandedCadastro ? 'bg-zinc-50' : 'bg-white'} dark:bg-neutral-900 flex flex-col gap-2 flex-1 w-full min-h-screen`}>
